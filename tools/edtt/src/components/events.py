...
class Event:
    ...
    __cceFormats__ = { CmdOpcodes.BT_HCI_OP_SET_EVENT_MASK:                'Command Complete Event for Set Event Mask status 0x{2:02X}',
                       ...
                       CmdOpcodes.BT_HCI_OP_LE_READ_FAL_SIZE:              'Command Complete Event for LE Read Filter Accept List Size status 0x{2:02X} list size {3:d}',
                       CmdOpcodes.BT_HCI_OP_LE_CLEAR_FAL:                  'Command Complete Event for LE Clear Filter Accept List status 0x{2:02X}',
                       CmdOpcodes.BT_HCI_OP_LE_ADD_DEV_TO_FAL:             'Command Complete Event for LE Add Device To Filter Accept List status 0x{2:02X}',
                       CmdOpcodes.BT_HCI_OP_LE_REM_DEV_FROM_FAL:           'Command Complete Event for LE Remove Device From Filter Accept List status 0x{2:02X}',
