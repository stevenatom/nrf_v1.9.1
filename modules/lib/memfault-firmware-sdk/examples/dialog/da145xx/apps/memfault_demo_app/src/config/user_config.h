...
/***************************************************************************************/
/* Override SDK based assertion checks with memfault versions allowing logging.        */
/***************************************************************************************/
#include "memfault/panics/assert.h"
#define ASSERT_ERROR(x)             MEMFAULT_ASSERT(x);
#define ASSERT_WARNING(x)           MEMFAULT_ASSERT(x);
