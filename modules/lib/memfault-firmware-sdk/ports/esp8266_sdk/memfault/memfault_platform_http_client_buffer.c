...
#error "MEMFAULT_HTTP_CLIENT_MAX_BUFFER_SIZE must be greater than 512 bytes"
#endif
...
void *memfault_http_client_allocate_chunk_buffer(size_t *buffer_size) {
  ...
  // be from a network perspective. Let's start by trying to use a 4kB buffer and slim
