...
//!
//! Utilities that can be used alongside STM32L4 coredump storage flash port
...
//!
//! @note The STM32L4 ECCs every double-word write. There is a low probability that
...
//! the failing address. See https://mflt.io/stm32l4-ecc-error-recovery for more context
//!
//! @param[in] start_addr The start address of the range to clear ECC errors in
//! @param[in] end_addr The end address pf the range to clear ECC errors in
