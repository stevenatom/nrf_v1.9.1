...
SHELL_STATIC_SUBCMD_SET_CREATE(
	sub_bg,
	SHELL_CMD(startbg, NULL, "iperf3 <params>\nStart a background thread.", cmd_th_startbg),
	SHELL_CMD(startfg, NULL, "iperf3 <params>\nStart a foreground thread.", cmd_th_startfg),
	SHELL_CMD_ARG(
		results, NULL,
...
SHELL_CMD_REGISTER(th, &sub_bg, "Commands for running iperf3 in separate threads.", cmd_th);
