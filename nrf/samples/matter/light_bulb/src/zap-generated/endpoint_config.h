	...
	{                                                                                                                              \
		{ 0x0000001D, ZAP_ATTRIBUTE_INDEX(0), 6, 6, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster:                 \
			...
			{ 0x00000034, ZAP_ATTRIBUTE_INDEX(50), 5, 6, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,                 \
													  ...
													  Diagnostics                  \
													  (server) */                  \
			{ 0x00000035, ZAP_ATTRIBUTE_INDEX(55), 65, 6, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint:                   \
													   0, Cluster:                 \
													   Thread                      \
													   Network                     \
													   Diagnostics                 \
													   (server) */                 \
			{ 0x0000003C, ZAP_ATTRIBUTE_INDEX(120), 5, 10, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint:                  \
													    0,                         \
													    Cluster:                   \
													    AdministratorCommissioning \
													    (server)                   \
													  */                           \
			{ 0x0000003E, ZAP_ATTRIBUTE_INDEX(125), 8, 6, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint:                   \
													   0, Cluster:                 \
													   Operational                 \
													   Credentials                 \
													   (server) */                 \
